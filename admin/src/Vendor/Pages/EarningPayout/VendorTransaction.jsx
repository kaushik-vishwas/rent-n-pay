...
import { apiGetVendorSettlements } from '@/service/api';
...
const VendorTransaction = () => {
  ...
  const transactions = useMemo(() => {
    ...
    const mapped = filteredSettlements.map((s) => {
      ...
      // Gross amount = rent + security deposit (same as settlements page)
      ...
      // display so vendors see the full settled amount reaching their bank.
      ...
      return {
        date: s?.createdAt
          ...
          : '—',
        id: `ORD-${String(s?.orderId?.orderNumber ?? s?.orderNumber ?? 0).padStart(4, '0')}`,
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(
      workbook,
      `my-transactions-${new Date().toISOString().slice(0, 10)}.xlsx`,
    );
  };
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-3">
              <div className="relative w-full sm:max-w-xs">
                ...
                <input
                  ...
                  placeholder="Search order ID or date..."
